...
- [`llm`](/docs/reference/api/llm-agents/llm) — ChatModel interface agents use for reasoning
- [`tool`](/docs/reference/api/llm-agents/tool) — Tool interface and FuncTool
- [`core`](/docs/reference/api/foundation/core) — Runnable, errors, context helpers
