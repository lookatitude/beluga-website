...
- [`agent`](/docs/reference/api/llm-agents/agent) — Agent uses tools via WithTools and handoffs
- [`llm`](/docs/reference/api/llm-agents/llm) — BindTools attaches tool definitions to a ChatModel
- [`core`](/docs/reference/api/foundation/core) — IsRetryable, typed errors used by middleware
