...
|---|---|---|---|
| [Braintrust](/docs/reference/providers/eval/braintrust) | `braintrust_` | `factuality` | Cloud-hosted evaluation via Braintrust API |
| [DeepEval](/docs/reference/providers/eval/deepeval) | `deepeval_` | `faithfulness` | Evaluation via DeepEval server |
| [RAGAS](/docs/reference/providers/eval/ragas) | `ragas_` | `faithfulness` | RAG-focused evaluation via RAGAS server |
