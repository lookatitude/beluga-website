...
| [Silero](/docs/reference/providers/vad/silero) | `silero` | ONNX model-based detection with energy fallback |
| [WebRTC](/docs/reference/providers/vad/webrtc) | `webrtc` | Energy + zero-crossing rate analysis |
