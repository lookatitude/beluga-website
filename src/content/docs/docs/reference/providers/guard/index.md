...
|---|---|---|
| [Azure Content Safety](/docs/reference/providers/guard/azuresafety) | `azure_content_safety` | Microsoft Azure AI Content Safety |
| [Guardrails AI](/docs/reference/providers/guard/guardrailsai) | `guardrails_ai` | Guardrails AI validators (PII, toxicity, hallucination) |
| [Lakera Guard](/docs/reference/providers/guard/lakera) | `lakera_guard` | Lakera prompt injection and content detection |
| [LLM Guard](/docs/reference/providers/guard/llmguard) | `llm_guard` | LLM Guard prompt and output scanning |
| [NeMo Guardrails](/docs/reference/providers/guard/nemo) | `nemo_guardrails` | NVIDIA NeMo Guardrails with Colang configs |
