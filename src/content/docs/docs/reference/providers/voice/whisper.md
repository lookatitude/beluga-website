...
For real-time transcription with interim results, consider [Deepgram](/docs/reference/providers/voice/deepgram) or [AssemblyAI](/docs/reference/providers/voice/assemblyai) which support native WebSocket streaming.
