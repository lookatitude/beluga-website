...
|----------|---------------|-----------|-------------|
| [Deepgram](/docs/reference/providers/voice/deepgram) | `deepgram` | Native WebSocket | Real-time STT with Nova-2 models |
| [AssemblyAI](/docs/reference/providers/voice/assemblyai) | `assemblyai` | Native WebSocket | Real-time and async transcription |
| [OpenAI Whisper](/docs/reference/providers/voice/whisper) | `whisper` | Chunked batch | Whisper models via OpenAI API |
| [Gladia](/docs/reference/providers/voice/gladia) | `gladia` | Native WebSocket | Real-time STT with language detection |
| [ElevenLabs STT](/docs/reference/providers/voice/elevenlabs) | `elevenlabs` | Chunked batch | Scribe transcription engine |
| [Groq Whisper](/docs/reference/providers/voice/groq-whisper) | `groq` | Buffered batch | Ultra-fast Whisper inference on LPU |

## TTS Providers

| Provider | Registry Name | Description |
|----------|---------------|-------------|
| [ElevenLabs](/docs/reference/providers/voice/elevenlabs) | `elevenlabs` | Premium voice cloning and synthesis |
| [Cartesia](/docs/reference/providers/voice/cartesia) | `cartesia` | Low-latency Sonic voice engine |
| [PlayHT](/docs/reference/providers/voice/playht) | `playht` | AI voice generation platform |
| [LMNT](/docs/reference/providers/voice/lmnt) | `lmnt` | Ultra-low-latency voice synthesis |
| [Fish Audio](/docs/reference/providers/voice/fish) | `fish` | Open-source voice synthesis |
| [Smallest AI](/docs/reference/providers/voice/smallest) | `smallest` | Lightning-fast TTS engine |
| [Groq TTS](/docs/reference/providers/voice/groq-whisper) | `groq` | Fast TTS via Groq API |

## S2S Providers

| Provider | Registry Name | Description |
|----------|---------------|-------------|
| [OpenAI Realtime](/docs/reference/providers/voice/openai-realtime) | `openai_realtime` | Bidirectional audio via WebSocket |
| [Gemini Live](/docs/reference/providers/voice/gemini-live) | `gemini_live` | Google's live multimodal API |
| [Amazon Nova S2S](/docs/reference/providers/voice/nova-s2s) | `nova` | Nova Sonic via AWS Bedrock |
