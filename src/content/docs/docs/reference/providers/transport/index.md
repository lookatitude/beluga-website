...
| [Daily](/docs/reference/providers/transport/daily) | `daily` | WebRTC | Daily.co room-based audio transport |
| [LiveKit](/docs/reference/providers/transport/livekit) | `livekit` | WebRTC | LiveKit room-based audio transport |
| [Pipecat](/docs/reference/providers/transport/pipecat) | `pipecat` | WebSocket | Pipecat server audio transport |
