...
|---|---|---|---|
| [Cloud Storage](/docs/reference/providers/loader/cloudstorage) | `cloudstorage` | `s3://`, `gs://`, `az://` URIs | AWS S3, Google Cloud Storage, Azure Blob |
| [Confluence](/docs/reference/providers/loader/confluence) | `confluence` | Page ID or `SPACE/page-id` | Atlassian Confluence wiki pages |
| [Docling](/docs/reference/providers/loader/docling) | `docling` | File path or URL | IBM Docling document conversion (PDF, DOCX, images) |
| [Firecrawl](/docs/reference/providers/loader/firecrawl) | `firecrawl` | URL | Web scraping with JavaScript rendering |
| [Google Drive](/docs/reference/providers/loader/gdrive) | `gdrive` | File ID | Google Drive files and Google Workspace exports |
| [GitHub](/docs/reference/providers/loader/github) | `github` | `owner/repo/path` | GitHub repository files via the Contents API |
| [Notion](/docs/reference/providers/loader/notion) | `notion` | Page ID | Notion pages via the Notion API |
| [Unstructured](/docs/reference/providers/loader/unstructured) | `unstructured` | File path | Unstructured.io document extraction |
