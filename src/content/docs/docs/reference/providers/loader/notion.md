...
Choose Notion when your team's knowledge base or documentation lives in Notion and you want to feed page content into a RAG pipeline. The loader extracts plain text from paragraphs, headings, lists, quotes, callouts, and code blocks. For Atlassian wikis, consider [Confluence](/docs/reference/providers/loader/confluence). For Google-based content, consider [Google Drive](/docs/reference/providers/loader/gdrive).
