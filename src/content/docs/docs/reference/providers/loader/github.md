...
Choose GitHub when you need to load source code, documentation, or configuration files from GitHub repositories into a RAG pipeline. The loader supports branch/tag/SHA references and works with both GitHub.com and GitHub Enterprise. For loading from other platforms, consider [Confluence](/docs/reference/providers/loader/confluence) or [Notion](/docs/reference/providers/loader/notion).
