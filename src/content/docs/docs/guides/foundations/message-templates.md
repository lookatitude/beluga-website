...
- [Reusable System Prompts](/docs/guides/foundations/reusable-system-prompts) — Build a persona library
- [Multi-turn Conversations](/docs/guides/foundations/multiturn-conversations) — Use templates in conversation flows
