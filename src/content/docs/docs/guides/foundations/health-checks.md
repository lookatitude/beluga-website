...
- [OpenTelemetry Tracing](/docs/guides/foundations/otel-tracing) — Debug issues found by health checks
- [Prometheus and Grafana](/docs/guides/foundations/prometheus-grafana) — Metrics visualization
