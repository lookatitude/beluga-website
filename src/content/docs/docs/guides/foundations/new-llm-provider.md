...
- [Advanced Inference Options](/docs/guides/foundations/advanced-inference) — Control generation parameters
- [Model Switching](/docs/guides/capabilities/agents/model-switching) — Build fallback chains across providers
