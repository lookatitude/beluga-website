...
- Understanding of [Message Template Design](/docs/guides/foundations/message-templates)
...
- [Research Agent](/docs/guides/capabilities/agents/research-agent) — Apply personas to autonomous agents
- [Message Template Design](/docs/guides/foundations/message-templates) — Advanced template patterns
