...
- Understanding of [In-memory Vector Store](/docs/guides/foundations/inmemory-vectorstore)
...
- [Hybrid Search](/docs/guides/capabilities/rag/hybrid-search) — Combine vector and keyword search
- [In-memory Vector Store](/docs/guides/foundations/inmemory-vectorstore) — Zero-dependency development
