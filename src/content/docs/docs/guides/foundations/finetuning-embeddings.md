...
- Understanding of [Multimodal Embeddings](/docs/guides/foundations/multimodal-embeddings)
...
See [Hybrid Search](/docs/guides/capabilities/rag/hybrid-search) for the full implementation.
...
- [Multimodal Embeddings](/docs/guides/foundations/multimodal-embeddings) — Embed images and text
- [pgvector Sharding](/docs/guides/foundations/pgvector-sharding) — Scale to millions of vectors
