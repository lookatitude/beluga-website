...
- [Adding a New LLM Provider](/docs/guides/foundations/new-llm-provider) — Extend the framework with custom providers
- [Multi-provider Chat](/docs/guides/capabilities/agents/multi-provider) — Use multiple providers together
