...
description: "Build an event-driven S3 document loader for Beluga AI that auto-ingests files into RAG pipelines using S3 events and SQS triggers."
head:
  - tag: meta
    attrs:
      name: keywords
      content: "AWS S3 loader, event-driven ingestion, Beluga AI, S3 events, SQS trigger, document loader Go, RAG pipeline"
---
...
- [Google Drive Scraper](/docs/guides/production/integrations/google-drive-scraper) -- Google Drive document loading
