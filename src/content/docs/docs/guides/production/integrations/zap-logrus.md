---
title: Zap & Logrus Logger Providers
description: "Integrate Uber Zap or Logrus structured logging with Beluga AI for high-throughput observability and OpenTelemetry trace correlation."
head:
  - tag: meta
    attrs:
      name: keywords
      content: "Zap logging, Logrus, structured logging, Beluga AI, trace correlation, OpenTelemetry logs, Go logger provider"
---
...
- [Context Deep Dive](/docs/guides/production/integrations/context-deep-dive) -- Advanced context patterns for cancellation and timeouts
- [Infrastructure Integrations](/docs/guides/production/integrations/infrastructure) -- Deployment and infrastructure overview
