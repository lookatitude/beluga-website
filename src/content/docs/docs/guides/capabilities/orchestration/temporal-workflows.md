...
- [DAG Workflows](/docs/guides/capabilities/orchestration/dag-workflows) -- Complex graph-based flows that can be used as activities
- [Human-in-the-Loop](/docs/guides/production/human-in-loop) -- Confidence-based approval policies for tool execution
