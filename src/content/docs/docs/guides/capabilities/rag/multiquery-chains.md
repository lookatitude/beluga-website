...
- Understanding of [Hybrid Search](/docs/guides/capabilities/rag/hybrid-search) and the [ChatModel interface](/docs/guides/llm)
...
- [Hybrid Search](/docs/guides/capabilities/rag/hybrid-search) -- Combine with keyword search for even better recall
- [Fine-tuning Embeddings](/docs/guides/foundations/finetuning-embeddings) -- Optimize the embedding model
