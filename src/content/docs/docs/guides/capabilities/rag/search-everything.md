...
- [Customer Support Gateway](/docs/guides/support-gateway/) for API gateway patterns
- [Knowledge QA System](/docs/guides/knowledge-qa/) for semantic search patterns
