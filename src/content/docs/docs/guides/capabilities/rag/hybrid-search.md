...
- [Multi-query Retrieval](/docs/guides/capabilities/rag/multiquery-chains) -- Expand queries for better recall
- [pgvector Sharding](/docs/guides/foundations/pgvector-sharding) -- Scale the vector backend
