...
- [Markdown Chunking](/docs/guides/capabilities/documents/markdown-chunking) -- Combine structural and semantic splitting strategies
- [Lazy-Loading Documents](/docs/guides/capabilities/documents/lazy-loading) -- Process large document collections efficiently
