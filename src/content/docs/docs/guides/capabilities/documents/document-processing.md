...
- Read [RAG Recipes](/docs/recipes/rag-recipes) for advanced patterns
- Check out [Document Loader Integrations](/docs/guides/production/integrations/document-loaders) for more sources
