...
- [Semantic Splitting](/docs/guides/capabilities/documents/semantic-splitting) -- Split by meaning rather than structure
- [Directory and PDF Scraper](/docs/guides/capabilities/documents/pdf-scraper) -- Load files to split
