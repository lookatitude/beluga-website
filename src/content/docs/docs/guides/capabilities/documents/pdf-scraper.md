...
- [Lazy-Loading](/docs/guides/capabilities/documents/lazy-loading) -- Process millions of files with constant memory usage
- [Markdown Chunking](/docs/guides/capabilities/documents/markdown-chunking) -- Split loaded Markdown documents by heading structure
