...
- [Audio Analysis](/docs/guides/capabilities/multimodal/audio-analysis) -- Process audio files with multimodal models
- [Content Moderation](/docs/guides/production/content-moderation) -- Validate image descriptions before returning to users
