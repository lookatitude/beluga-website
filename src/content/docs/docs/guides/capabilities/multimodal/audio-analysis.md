...
- [Visual Reasoning](/docs/guides/capabilities/multimodal/visual-reasoning) -- Analyze images alongside text
- [Lazy-Loading Documents](/docs/guides/capabilities/documents/lazy-loading) -- Process large collections of media files efficiently
