...
- [Tools Registry](/docs/guides/capabilities/agents/tools-registry) -- Build a reusable tool library for agents
- [Model Switching](/docs/guides/capabilities/agents/model-switching) -- Implement fallback chains
