...
- [Multi-Agent Orchestration](/docs/guides/capabilities/agents/multi-agent-orchestration) -- Coordinate teams of agents
- [Tools Registry](/docs/guides/capabilities/agents/tools-registry) -- Build a reusable tool library
