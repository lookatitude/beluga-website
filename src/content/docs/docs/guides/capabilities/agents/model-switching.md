...
- Understanding of the [ChatModel interface](/docs/guides/llm) and [middleware](/docs/guides/foundations/middleware-implementation)
...
- [Multi-provider Chat](/docs/guides/capabilities/agents/multi-provider) -- Unified interface across providers
- [Advanced Inference](/docs/guides/foundations/advanced-inference) -- Per-call generation options
