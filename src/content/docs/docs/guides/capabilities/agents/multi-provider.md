...
- [Model Switching and Fallbacks](/docs/guides/capabilities/agents/model-switching) -- Automate provider selection
- [Adding a New LLM Provider](/docs/guides/foundations/new-llm-provider) -- Register custom providers
