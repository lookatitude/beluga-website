...
- Completion of [Sentence-Boundary Turn Detection](/docs/guides/capabilities/voice/sentence-boundary) is recommended
...
For simpler use cases with structured speech (commands, short queries), the heuristic provider in [Sentence-Boundary Turn Detection](/docs/guides/capabilities/voice/sentence-boundary) is sufficient and avoids the complexity of model management.
...
- [Sentence-Boundary Turn Detection](/docs/guides/capabilities/voice/sentence-boundary) -- Heuristic alternative for simpler use cases
- [Sensitivity Tuning](/docs/guides/capabilities/voice/sensitivity-tuning) -- Combine turn detection with VAD tuning
- [Custom Silero VAD](/docs/guides/capabilities/voice/custom-silero-vad) -- Neural VAD for voice activity detection
