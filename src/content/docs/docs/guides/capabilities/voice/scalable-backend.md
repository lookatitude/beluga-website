...
- Completion of [LiveKit and Vapi Integration](/docs/guides/capabilities/voice/livekit-vapi) is recommended
...
- [LiveKit and Vapi Integration](/docs/guides/capabilities/voice/livekit-vapi) -- Provider-specific configuration details
- [Native S2S with Amazon Nova](/docs/guides/capabilities/voice/s2s-amazon-nova) -- S2S pipeline configuration
- [Sensitivity Tuning](/docs/guides/capabilities/voice/sensitivity-tuning) -- Tune the VAD and turn detection in your pipeline
