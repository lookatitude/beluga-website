...
- [Meeting Minutes](/docs/guides/meeting-minutes/) for real-time transcription patterns
- [Noise-Resistant VAD](/docs/guides/noise-resistant-vad/) for voice activity detection in noisy environments
