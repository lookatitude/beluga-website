...
- [Multi-Speaker Segmentation](/docs/guides/multi-speaker-segmentation/) for multi-speaker scenarios
- [Barge-In Detection](/docs/guides/barge-in-detection/) for VAD in barge-in detection
- [Industrial Control](/docs/guides/industrial-control/) for voice commands in noisy environments
