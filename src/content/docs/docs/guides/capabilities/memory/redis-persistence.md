...
- Understanding of [Multi-turn Conversations](/docs/guides/foundations/multiturn-conversations)
...
- [Summary and Window Patterns](/docs/guides/capabilities/memory/summary-window) -- Optimize memory for long conversations
- [Multi-turn Conversations](/docs/guides/foundations/multiturn-conversations) -- Message management fundamentals
