...
- [LLM API Reference](/docs/api-reference/llm-agents/llm) -- full `ChatModel` API
- [Streaming Tool Calls](/docs/cookbook/llm/streaming-tool-calls) -- handling tool calls in streams
- [Token Counting](/docs/cookbook/llm/token-counting) -- tracking token usage
