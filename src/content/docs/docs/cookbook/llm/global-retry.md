...
- **[LLM Error Handling](/docs/cookbook/llm/llm-error-handling)** -- Classification and handling of LLM API errors
- **[Circuit Breaker](/docs/cookbook/infrastructure/#circuit-breaker-for-provider-outages)** -- Short-circuit repeated failures
