...
- **[History Trimming](/docs/cookbook/llm/history-trimming)** -- Manage conversation history within context limits
- **[Streaming Tool Calls](/docs/cookbook/llm/streaming-tool-calls)** -- Handle tool calls in streaming responses
