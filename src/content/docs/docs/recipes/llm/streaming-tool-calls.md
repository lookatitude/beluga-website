...
- **[Streaming Metadata](/docs/recipes/llm/streaming-metadata)** -- Capture token counts and finish reasons from streams
- **[Tool Middleware](/docs/recipes/agents/tool-recipes)** -- Apply retry and auth middleware to tools
