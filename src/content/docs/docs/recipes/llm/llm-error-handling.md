...
- **[Custom Agent Patterns](/docs/recipes/agents/custom-agent-patterns)** -- Use error handling in custom agents
- **[Global Retry Wrappers](/docs/recipes/llm/global-retry)** -- Framework-level retry strategies
- **[Context Timeout Management](/docs/recipes/infrastructure/context-timeout)** -- Timeout handling for operations
