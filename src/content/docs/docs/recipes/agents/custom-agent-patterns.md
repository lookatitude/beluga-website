...
- **[Agent Handoffs](/docs/recipes/agents/#agent-handoffs)** -- Route conversations between specialist agents
- **[LLM Error Handling](/docs/recipes/llm/llm-error-handling)** -- Handle errors in your custom agent
