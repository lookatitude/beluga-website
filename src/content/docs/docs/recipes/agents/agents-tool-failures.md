...
- **[Streaming Tool Calls](/docs/recipes/llm/streaming-tool-calls)** -- Handle tools in streaming
- **[Parallel Step Execution](/docs/recipes/agents/agents-parallel-execution)** -- Execute steps in parallel
