...
- **[Dynamic Message Chain Templates](/docs/recipes/prompts/dynamic-templates)** -- Build message chains dynamically
- **[Streaming Tool Calls](/docs/recipes/llm/streaming-tool-calls)** -- Streaming patterns
