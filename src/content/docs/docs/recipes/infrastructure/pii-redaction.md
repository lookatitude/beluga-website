...
- [Prompt Injection Detection](/docs/recipes/prompt-injection-detection) — Additional safety patterns
- [Config Masking Secrets in Logs](/docs/recipes/config-secret-masking) — Secret masking
