...
- [Parent Document Retrieval (PDR)](/docs/recipes/parent-document-retrieval) -- Retrieve parent documents
- [Vectorstores Advanced Meta-filtering](/docs/recipes/meta-filtering) -- Advanced filtering
