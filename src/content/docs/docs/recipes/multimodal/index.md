...
- **[Streaming Chunks with Metadata](/docs/recipes/llm/streaming-metadata)** -- Capture token counts from multimodal streaming calls
- **[LLM Error Handling](/docs/recipes/llm/llm-error-handling)** -- Handle provider errors for multimodal requests
